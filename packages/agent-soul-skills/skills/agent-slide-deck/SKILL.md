...
```bash
# 基本用法
bun run skills/agent-slide-deck/scripts/main.ts content.md

# 指定风格和数量
bun run skills/agent-slide-deck/scripts/main.ts content.md --style sketch-notes --slides 8
```
...
**生成命令:**
```bash
bun run skills/agent-slide-deck/scripts/main.ts content.md --style sketch-notes --slides 5
```
