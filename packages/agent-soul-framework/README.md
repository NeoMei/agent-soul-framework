...
> `@neomei/opencode-feishu`、`@neomei/opencode-qiwei` 已随核心框架自动安装，无需单独 `npm install`。
...
npm install -g @neomei/agent-soul-framework @neomei/opencode-feishu @neomei/opencode-qiwei

# 可选：安装含 Python 脚本的技能包
