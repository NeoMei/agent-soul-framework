...
| 模型 | 能力 | 说明 |
|------|------|------|
| doubao-seedream-5-0-260128 | 图像生成+编辑 | 点点拍照用的模型 |
...
- 图像编辑：`skills/diandian-image-edit/scripts/edit_image.sh`
- 批量编辑：`skills/diandian-image-edit/scripts/batch_edit.sh`
