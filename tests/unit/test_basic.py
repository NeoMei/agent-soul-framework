...
class TestSkills(unittest.TestCase):
    ...
    def test_skills_exist(self):
        required_skills = [
            "diandian-photo", "diandian-voice", "diandian-vision",
            "diandian-hearing", "diandian-moltbook", "wechat-mp-assistant"
        ]
    ...
    def test_skill_scripts_exist(self):
        skill_scripts = {
            "diandian-photo": ["send_image.cjs", "send_image_v2.cjs"],
            "diandian-voice": ["tts.sh", "send_voice.cjs", "send_voice_v2.cjs"],
            "diandian-vision": ["vision.py"],
            "diandian-hearing": ["hear.py"],
            "diandian-moltbook": ["moltbook_api.py", "moltbook_social.py"],
        }
