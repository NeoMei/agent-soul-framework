...
| 包名 | 说明 | 安装 |
|------|------|------|
| [`@neomei/agent-soul-framework`](packages/agent-soul-framework) | 魂器核心框架，纯 TypeScript，内置灵魂注入插件 | `npm i -g @neomei/agent-soul-framework` |
| [`@neomei/agent-soul`](packages/agent-soul) | 已合并到核心框架，保留为空包兼容旧命令 | `npm i -g @neomei/agent-soul-framework` |
| [`@neomei/agent-soul-skills`](packages/agent-soul-skills) | 可选技能插件包，含 Python 脚本 | `npm i -g @neomei/agent-soul-skills` |

核心框架可独立运行，技能包与 channel 插件（飞书/企微）按需安装。
